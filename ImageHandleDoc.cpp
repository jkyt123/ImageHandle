...
// ImageHandleDoc.cpp: CImageHandleDoc 类的实现
//
...
// CImageHandleDoc 构造/析构

CImageHandleDoc::CImageHandleDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CImageHandleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CImageHandleDoc::InitializeSearchContent()
{
...
void CImageHandleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
